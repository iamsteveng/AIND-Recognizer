...
class TestSelectors(TestCase):
    ...
    # @unittest.skip("Skip test_select_constant_interface")
    ...
    # @unittest.skip("Skip test_select_bic_interface")
    ...
    # @unittest.skip("Skip test_select_cv_interface")
    ...
    # @unittest.skip("Skip test_select_dic_interface")
